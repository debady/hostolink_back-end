...
export class CommentaireController {
  ...
  // ✅ permettre la suppression d’un commentaire
  @Delete(':id_publication/commentaire/:id_commentaire')
  async deleteComment(
  @Param('id_commentaire', ParseIntPipe) id_commentaire: number,
  @Body() body: { id_user: number } // Récupérer l'id de l'utilisateur
  ) {
