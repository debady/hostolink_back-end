...
CREATE TABLE public.user_etablissement_sante (
    ...
    url_image_profile character varying,
...
COPY public.code_verif_otp (id, otp_code, expires_at, is_valid, moyen_envoyer, id_user) FROM stdin;
35	974593	2025-03-16 21:45:11.659	t	telephone	1449f75d-94f6-42c0-b524-e83a0958740a
37	258134	2025-03-16 21:50:27.719	t	telephone	82eb0a11-9d17-4cad-a97e-c23ce87b250f
\.
...
COPY public.user_etablissement_sante (id_user_etablissement_sante, nom, telephone, categorie, adresse, creat_at, latitude, longitude, geom, url_image_profile, specialites) FROM stdin;
\.
...
COPY public.utilisateur (date_inscription, "position", email, telephone, mdp, nom, prenom, pays, photo_profile, raison_banni, id_user, compte_verifier, dernier_otp_envoye) FROM stdin;
2025-03-16 21:44:47.308	\N	\N	+2250502556104	\N	\N	\N	\N	\N	\N	82eb0a11-9d17-4cad-a97e-c23ce87b250f	f	2025-03-16 20:45:28.192
2025-03-16 21:01:45.528	\N	\N	+2250544704854	$2b$10$n5cgaImg7Iq1/wYmCoVCX.ktlaJPrTqjrxLMSk8j7iBkbykgLISia	\N	\N	\N	\N	\N	1449f75d-94f6-42c0-b524-e83a0958740a	f	2025-03-16 20:40:12.124
\.
...
SELECT pg_catalog.setval('public.code_verif_otp_id_seq', 37, true);
