...
let PaiementService = class PaiementService {
    ...
    async payerParQr(shortId, idCompteEtablissement, montant, idUser) {
        ...
        const [compteUtilisateur] = await this.dataSource.query(`SELECT * FROM compte WHERE id_user = $1 AND statut = 'actif' LIMIT 1`, [idUser]);
        ...
        const [compteEtablissement] = await this.dataSource.query(`SELECT * FROM compte WHERE id_compte = $1 LIMIT 1`, [idCompteEtablissement]);
        ...
        const [compteEtabMaj] = await this.dataSource.query(`SELECT solde_compte FROM compte WHERE id_compte = $1`, [compteEtablissement.id_compte]);
    ...
    async payerParIdentifiant(identifiant, montant, idUser) {
        ...
        const [etab] = await this.dataSource.query(`SELECT * FROM user_etablissement_sante 
        ...
        const [compteEtablissement] = await this.dataSource.query(`SELECT * FROM compte WHERE id_user_etablissement_sante = $1 LIMIT 1`, [etabId]);
        if (!compteEtablissement) {
