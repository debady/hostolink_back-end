...
exports.InvitationModule = InvitationModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([invitation_entity_1.Invitation, user_entity_1.User, invitation_traking_entity_1.InvitationTracking, compte_entity_1.Compte])],
