...
let UserService = class UserService {
    ...
    async registerUser(identifier) {
        try {
            ...
            if (existingUser) {
                throw new common_1.ConflictException("Cet identifiant est déjà utilisé.");
            }
    ...
    async getAllUsers() {
        try {
            ...
            throw new common_1.InternalServerErrorException("Impossible de récupérer les utilisateurs");
        }
    }
